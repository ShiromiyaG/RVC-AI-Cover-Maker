...
def process_spectrogram(args=None):
    parser = argparse.ArgumentParser(description='Process some integers.')
    parser.add_argument('--audio_input', nargs='+', help='List of audio input files')
    parser.add_argument('--algorithm', help='Algorithm to use')
    parser.add_argument('--is_normalization', type=bool, help='Whether to normalize or not')
    parser.add_argument('--wav_type_set', help='Type of wav file')
    parser.add_argument('--save_path', help='Path to save the output')
    parser.add_argument('--is_wave', type=bool, default=False, help='Whether input is wave or not')
    parser.add_argument('--is_array', type=bool, default=False, help='Whether input is array or not')

    args = parser.parse_args()

    ensemble_inputs(args.audio_input, args.algorithm, args.is_normalization, args.wav_type_set, args.save_path, args.is_wave, args.is_array)
